...
namespace SSW.WebApiHelper
{
    public interface IWebApiService
    {
        ...
        WebApiServiceResponse Get(string baseUrl, string resource, dynamic argument, IEnumerable<HttpStatusCode> overrideSuccessStatusCodes = null);
        ...
        WebApiServiceResponse Post(string baseUrl, string resource, dynamic argument, IEnumerable<HttpStatusCode> overrideSuccessStatusCodes = null);
        ...
        WebApiServiceResponse Put(string baseUrl, string resource, dynamic argument, IEnumerable<HttpStatusCode> overrideSuccessStatusCodes = null);
        ...
        WebApiServiceResponse Delete(string baseUrl, string resource, dynamic argument, IEnumerable<HttpStatusCode> overrideSuccessStatusCodes = null);
